...
class LoisirsController
{
    ...
    public function save($op)
    {
        ...
        $values = ($op == 'update') ? $this->db->select($id) : ''; // si on a envoyé un id dans l'URL, on l'envoi en argument de la méthode select() de EntityLoisirsRepository, cela permettra de selectionner toute les données de l'employé pour les modification.
